...
window.axios = __webpack_require__(/*! axios */ "./node_modules/axios/index.js"); // console.log('testesta');
//
// console.log(window.axios);
//
// console.log(window.axios.defaults);
// console.log('testesta');
// Ajaxリクエストであることを示すヘッダーを付与する

window.axios.defaults.headers.common['X-Requested-With'] = 'XMLHttpRequest'; // console.log(window.axios.defaults.headers.common['X-Requested-With']);
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              console.log(context);
              console.log(data); // console.log(axios);
            ...
            case 5:
              ...
              context.commit('setUser', response.data); // context.commit('setUser', 'testtest')
...
__webpack_require__(/*! /Applications/MAMP/htdocs/spa_sample/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Applications/MAMP/htdocs/spa_sample/resources/sass/app.scss */"./resources/sass/app.scss");
